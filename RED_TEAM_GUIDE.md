...
To test a specific payload, open `plugins/agt-typescript/examples/test_agent.ts` and set:
...
The attack used in the included quickstart (`plugins/agt-typescript/examples/test_agent.ts`). An
...
- **Exact payload** pasted into `TEST_PROMPT` in `plugins/agt-typescript/examples/test_agent.ts`
