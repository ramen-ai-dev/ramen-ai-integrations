...
| `dsh-ramen-guard` | DeepSeek Harness | [`plugins/dsh-ramen-guard/`](plugins/dsh-ramen-guard/) | Unofficial Cordis guard that, in enforcement mode, blocks policy-violating tool intent before execution and requires a locally verified Ed25519 receipt for allowed calls. |
