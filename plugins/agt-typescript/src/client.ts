/**
 * RamenClient — synchronous-style (Promise-based) HTTP client for the
 * ramen-ai PaaS evaluation API, built on the global `fetch`.
 *
...
export class RamenClient {
   ...
   *
   * Fail-closed: any transport or parse error throws; callers (e.g. the
   * governance backend) must treat a thrown error as a denial.
   */
